...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  console.log('[home.js] Auth state — riq_uid:', localStorage.getItem('riq_uid'));
  console.log('[home.js] Auth state — riq_role:', localStorage.getItem('riq_role'));
  console.log('[home.js] Auth state — riq_name:', localStorage.getItem('riq_name'));
